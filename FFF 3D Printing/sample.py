...
# -*- coding: utf-8 -*-
"""
## NOT MY CODE. OBTAINED FROM https://www.kaggle.com/afumetto/3dprinter?select=printer_dataset.py
...
plt.scatter(absm.fan_speed,absm['tensile strength'],color="red",label="ABS",alpha= 0.5)
plt.scatter(pla.fan_speed,pla['tensile strength'],color="green",label="PLA",alpha= 0.5)
plt.xlabel("Fan Hızı")
...
plt.scatter(absm.layer_height,absm['tensile strength'],color="orange",label="ABS",alpha= 0.5)
plt.scatter(pla.layer_height,pla['tensile strength'],color="brown",label="PLA",alpha= 0.5)
plt.xlabel("Katman Yüksekliği")
plt.ylabel("Çekme Dayanımı")
plt.legend()
plt.show()
...
plt.scatter(pla.layer_height,pla['tensile strength'],color="green",label="PLA",alpha= 0.5)
plt.xlabel("Katman Yüksekliği")
plt.ylabel("Çekme Dayanımı")
plt.legend()
plt.show()

plt.scatter(absm.layer_height,absm['tensile strength'],color="red",label="ABS",alpha= 0.5)
plt.xlabel("Katman Yüksekliği")
plt.ylabel("Çekme Dayanımı")
plt.legend()
plt.show()
